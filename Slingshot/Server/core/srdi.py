...
def ConvertToShellcode(dll_bytes, function_name=b'', user_data=b'None', flags=0):
    ...
    function_hash = HashFunctionName(function_name)
    ...
    if is64BitDLL(dll_bytes):
        ...
        userDataLocation = dllOffset + len(dll_bytes)
        ...
        # DLL bytes
        # User data
        return bootstrap + rdiShellcode + dll_bytes + user_data
